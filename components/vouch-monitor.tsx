...
export function VouchMonitor() {
  ...
  return (
    <TooltipProvider>
            ...
            <nav className="flex items-center gap-6">
              ...
              <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogTrigger asChild>
                  <Button className="bg-emerald-600 hover:bg-emerald-700 h-10 px-4 cursor-pointer">
      ...
      {/* Main Content */}
      <main className="max-w-5xl mx-auto px-12 py-8 flex-1 min-h-[600px]">
        <div className="mb-6">
        ...
        <div className="mb-6 border-b">
          <div className="flex gap-8">
            <button
              ...
              className={`pb-3 px-1 border-b-2 transition-colors text-base cursor-pointer ${
                filterStatus === "all"
        ...
        {/* Users Table */}
        <div className="bg-white rounded-lg border min-h-[400px] w-full">
          <Table className="w-full">
            <TableHeader>
              <TableRow className="border-b bg-gray-50">
                <TableHead className="font-semibold text-gray-600 uppercase text-xs w-[200px]">Username</TableHead>
                <TableHead className="font-semibold text-gray-600 uppercase text-xs w-[150px]">Status</TableHead>
                <TableHead className="font-semibold text-gray-600 uppercase text-xs w-[200px]">Repository</TableHead>
                <TableHead className="font-semibold text-gray-600 uppercase text-xs w-[250px]">File Path</TableHead>
                <TableHead className="font-semibold text-gray-600 uppercase text-xs text-right w-[150px]">Discovered</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
                  ...
                  >
                    ...
                    >
                      {user.status === "vouch" ? (
                        ...
                        <span className="text-red-600 text-sm inline-flex items-center gap-1">
                          <svg className="w-4 h-4" viewBox="0 0 16 16" fill="currentColor">
                            <path d="M4.47.22A.75.75 0 015 0h6a.75.75 0 01.53.22l4.25 4.25c.141.14.22.331.22.53v6a.75.75 0 01-.22.53l-4.25 4.25A.75.75 0 0111 16H5a.75.75 0 01-.53-.22L.22 11.53A.75.75 0 010 11V5a.75.75 0 01.22-.53L4.47.22zm.84 1.28L1.5 5.31v5.38l3.81 3.81h5.38l3.81-3.81V5.31L10.69 1.5H5.31zM8 4a.75.75 0 01.75.75v3.5a.75.75 0 01-1.5 0v-3.5A.75.75 0 018 4zm0 8a1 1 0 100-2 1 1 0 000 2z"/>
                          </svg>
                          Denounced
